...
UTILS.object_sort_keys = function(obj) {
  var new_obj = {};
  var keys = _.sortBy(_.keys(obj), function(item) {return item;});
...
HELIOS.Election.prototype = { 
  ...
  get_hash: function() {
    ...
    // otherwise  
    return sha2.b64_sha256(this.toJSON());
  },
...
HELIOS.Election.fromJSONString = function(raw_json) {
  ...
  election.election_hash = sha2.b64_sha256(raw_json);
...
HELIOS.EncryptedVote.prototype = {
  ...
  get_hash: function() {
     return sha2.b64_sha256(JSON.stringify(this.toJSONObject()));
  },
